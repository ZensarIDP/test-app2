...
**Logs:**
- GKE: `kubectl logs -l app=test-app2 -n default`
...
**Generated by Backstage IDP** - test-app2
...
- **GitHub Repository:** [View on GitHub](https://github.com/group:default/developers/test-app2)
